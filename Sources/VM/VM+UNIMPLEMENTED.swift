...
extension VM {
  ...
  internal func run(command: String) throws -> PyResult {
  ...
  internal func run(modulePath: String) throws -> PyResult {
  ...
  internal static func unimplemented(fn: StaticString = #function) throws -> Never {
    try trap("Unimplemented '\(fn)'.")
  }
}
