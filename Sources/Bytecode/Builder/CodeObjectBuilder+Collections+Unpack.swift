...
extension CodeObjectBuilder {
  ...
  public func appendMapAdd(relativeStackIndex: Int) throws {
    assert(relativeStackIndex >= 0)
  ...
  public func appendUnpackEx(countBefore: Int, countAfter: Int) throws {
    ...
    let arg = try self.appendExtendedArgIfNeeded(encoded.value)
